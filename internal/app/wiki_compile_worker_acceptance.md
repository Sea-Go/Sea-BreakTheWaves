...
本机聚焦`GOMAXPROCS=2 go test -mod=readonly -race -p=1 -count=1 -run '^TestWikiCompileWorker' ./internal/app`退出0，最终含新代SUPERSEDED及提供方可选真票据回放的父日志SHA=`58fa9618ae4a84330862aea8dd04eaa09dcea0724950ac41b3f1db14fb7fab35`；`go vet -mod=readonly ./internal/app`退出0。提供方真RTW×DC隔离PG16冻结的无令牌票据JSONL内容SHA=`04d33b7f5e242b80c791c3697bcc8d5a8ac527ff130254607c16222872481aec`，本仓**只读**在其原Claim lease窗口重播十二键/八字段/完整Submit JCS且race同轮通过；它不是当前在线租约证明，也没有重跑该跨仓PG。本机可用盘约12Gi时暂停大PG/CH/race套验，保留已有证据与停止实例。
