...
go test -race -count=1 -v ./internal/content ./internal/artifacts | tee "$content_tmp/go-test.log"
go vet ./internal/content ./internal/artifacts ./internal/corpus ./migrations/content
