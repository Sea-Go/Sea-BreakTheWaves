...
func main() {
	...
	flag.StringVar(&profilesPath, "profiles", "service/search/internal/modelcontract/bge_m3/profiles.json", "pinned BGE profiles")
	flag.StringVar(&lockPath, "model-lock", "service/search/internal/modelcontract/bge_m3/model.lock.json", "pinned BGE model lock")
