...
func TestNewRecommendAgentValidation(t *testing.T) {
	if _, err := NewRecommendAgent(Dependencies{}); err == nil {
		t.Fatal("expected missing model error")
	}
	if _, err := NewRecommendAgent(Dependencies{Model: fixedModel{"ok"}}); err == nil {
