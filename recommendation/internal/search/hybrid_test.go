...
func TestHybridSearcher_Search_ParallelExecution(t *testing.T) {
	...
	v := &stubVectorRepo{
		denseFn:  func(ctx context.Context, q string, topK int, f domain.SearchFilter) ([]domain.SearchHit, error) { return slow() },
		sparseFn: func(ctx context.Context, q string, topK int, f domain.SearchFilter) ([]domain.SearchHit, error) { return slow() },
	}
	b := &stubBM25Repo{
		fn: func(ctx context.Context, q string, topK int, f domain.SearchFilter) ([]domain.SearchHit, error) { return slow() },
	}
