...
func buildTravelGeoConstraint(req domaintravel.TravelRequirementSnapshot, extraText string) TravelGeoConstraint {
...
func buildTravelGeoConstraintFromOverview(overview *graph.TripOverview) TravelGeoConstraint {
	...
	domaintravel.EnrichRequirementWithDeterministicFields(&req, req.DestinationScope)
...
func BuildTravelGeoConstraint(req domaintravel.TravelRequirementSnapshot, extraText string) TravelGeoConstraint {
	return buildTravelGeoConstraint(req, extraText)
}

func BuildTravelGeoConstraintFromOverview(overview *graph.TripOverview) TravelGeoConstraint {
	return buildTravelGeoConstraintFromOverview(overview)
}

func KnownGeoKeywords() []string {
	return knownGeoKeywords()
}
